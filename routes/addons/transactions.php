...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'user_role:admin|staff|customer|branch|captain']], function(){
	...
	Route::post('export/transactions','TransactionController@exportTransaction')->name('admin.transactions.export');
	Route::get('creditinvoice/pay/{trancsction_id}', 'TransactionController@creditPayment')->name('admin.transactions.paycredit');
