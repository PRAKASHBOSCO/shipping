...
Route::get('DeliveryTimes', 'DeliveryTimesController@ajaxGetDeliveryTimes')->name('deliveryTimes-api');
Route::get('DeliveryWeightConfigs', 'DeliveryWeightConfigsController@ajaxGetDeliveryWeightConfigs')->name('deliveryWeightConfigs-api');
Route::get('MissionShipments', 'Api\ShipmentController@getMissionShipments')->name('missionShipments-api');
Route::get('shipmentPackages', 'Api\ShipmentController@getShipmentPackages')->name('shipmentPackages-api');
Route::get('get-system-currency', 'CurrencyController@getSystemCurrency')->name('system-currency-api');
Route::get('shipment-tracking', 'Api\ShipmentController@tracking')->name('shipment-tracking-api');
...
Route::get('reasons', 'Api\MissionController@getReasons')->name('get-reasons');
...
Route::post('remove-shipment-from-mission', 'Api\MissionController@RemoveShipmetnFromMission')->name('remove-shipment-from-mission');
...
Route::get('get-wallet', 'Api\AuthController@getWallet')->name('get.wallet');
