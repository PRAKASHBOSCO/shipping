...
<head>
	...
	@else
		<title>@if(View::hasSection('sub_title')) @yield('sub_title') | @endif {{ translate('Champa Framework') }} </title>
	@endif
				...
				<div class="py-4 bg-white footer d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container text-center">
						...
						<div class="order-2 text-dark order-md-1">
							...
							<a href="https://www.champait.com/" target="_blank"
								class="text-dark-75 text-hover-primary">{{translate('TK Express')}}</a> <!--<span class="mr-2 text-muted font-weight-bold">{{translate('v')}}{{ get_setting('current_version') }}</span>-->
						</div>
