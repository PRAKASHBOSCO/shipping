...
class FranchiseController extends Controller {
    ...
    public function index() {
        $branches = Branch::where('is_archived', 0)->where('type', 2)->paginate(15);
        return view('backend.franchises.index', compact('branches'));
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            DB::commit();
            flash(translate("Franchise added successfully"))->success();
    ...
    public function show($id) {
        ...
        $shipments = \App\Shipment::where('branch_id', $id)->orderby('id', 'desc')->paginate(15);
        if ($branch != null) {
            return view('backend.franchises.show', compact('branch', 'shipments'));
        }
        abort(404);
    }
    ...
    public function edit($id) {
        ...
        $branch = Branch::where('id', $id)->first();
        if ($branch != null) {
            return view('backend.franchises.edit', compact('branch'));
        }
        abort(404);
    }
    ...
    public function destroy($Branch) {
        ...
        $model->is_archived = 1;
        if ($model->save()) {
            flash(translate('Franchise has been deleted successfully'))->success();
