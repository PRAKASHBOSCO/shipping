...
class ClientController extends Controller
{
    ...
    {
        $clients = Client::where('is_archived', 0)->where('id', '!=', '68')->paginate(15);
    ...
    public function create()
    {
        ...
        return view('backend.clients.create',compact('branchs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{	
            ...
            $userRegistrationHelper->setPhone($model->responsible_mobile);
     ...
     * @return \Illuminate\Http\Response
     */
    public function save(Request $request , $calc = false)
    {
    ...
    public function edit($id)
    {
        ...
        $branchs = Branch::where('is_archived',0)->get();
        if($client != null){
            return view('backend.clients.edit',compact(['client','branchs']));
        }
        abort(404);
    }
    ...
    public function addNewAddress(Request $request , $calc = false)
    {
        $client_address = new AddressClient();
