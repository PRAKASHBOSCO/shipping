...
class TransactionHelper{
    ...
    public function calculate_shipment_cost($shipment_id, $cod = false)
    {
        ...
        }else
        {
            ...
            {
                $cost += $shipment->shipping_cost + $shipment->tax + $shipment->insurance + $shipment->pickup_cost + $shipment->shipping_distance_cost + $shipment->cod_cost + $shipment->door_delivery_cost - $shipment->discount_amt;
            }
    ...
    public function create_mission_transaction($mission_id,$value,$transaction_owner,$transaction_owner_id,$operation, $type = \App\Transaction::MESSION_TYPE, $description = null)
    {
		...
		try {
            ...
            } elseif ($transaction_owner == Transaction::FRANCHISE) {
                $transaction->branch_id = $transaction_owner_id;
            }
    ...
    public function create_shipment_transaction($shipment_id,$value,$transaction_owner,$transaction_owner_id,$operation, $type, $description = null)
    {
