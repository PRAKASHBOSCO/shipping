                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            @if($mission->type == \App\Mission::getType(\App\Mission::DELIVERY_TYPE))
                                                <th class="text-right font-weight-bold text-muted text-uppercase ">{{translate('TOTAL COD AMOUNT')}}</th>
                                            @else
                                    ...
                                    <tbody>
                                        <tr class="font-weight-bolder">
                                            ...
                                            @if($mission->status_id == \App\Mission::DONE_STATUS && $mission->getOriginal('type') == \App\Mission::DELIVERY_TYPE)
