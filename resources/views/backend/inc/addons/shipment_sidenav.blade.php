            ...
            <li class="menu-item menu-item-submenu  {{ areActiveRoutes(['admin.shipments.index','admin.shipments.update','admin.shipments.import','admin.shipments.add.by.api','admin.shipments.create','admin.shipments.show'])}} @foreach(\App\Shipment::status_info() as $item) {{ areActiveRoutes([$item['route_name']])}} @endforeach " aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @if( in_array($user_type,['admin','captain','branch']) || in_array('1108', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
                        ...
                        @if( in_array($user_type,['admin','captain','branch']) || in_array('1109', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
                        ...
                        @foreach(\App\Shipment::status_info() as $item)
                            @if(in_array($user_type,['admin','captain','branch']) || in_array($item['permissions'], json_decode(Auth::user()->staff->role->permissions ?? "[]")))
...
@if ($addon != null)
    @if($addon->activated)
            ...
            <li class="menu-item menu-item-submenu  {{ areActiveRoutes(['admin.clients.index','admin.clients.update','admin.clients.create','admin.clients.show'])}}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        @if(in_array($user_type, ['admin','branch']) || in_array('1005', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
                                            ...
                                            <!--<li class="menu-item {{ areActiveRoutes(['admin.payments.index'])}}" aria-haspopup="true">
                                                <a href="{{ route('admin.payments.index') }}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">{{translate('All Payments')}}</span>

                                                </a>
                                            </li>
                                            <li class="menu-item {{ areActiveRoutes(['admin.payments.create'])}}" aria-haspopup="true">
                                                <a href="{{ route('admin.payments.create') }}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">{{translate('Add Payment')}}</span>
                        ...
                        <!--Franchises-->
                        @if(Auth::user()->user_type == 'admin' || in_array('1006', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
                            <li class="menu-item menu-item-submenu  {{ areActiveRoutes(['admin.franchises.index','admin.franchises.update','admin.franchises.create','admin.franchises.show'])}}" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <i class="menu-icon fas fa-hotel"></i>
                                    <span class="menu-text">{{translate('Franchises')}}</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        ...
                                        @if(Auth::user()->user_type == 'admin' || in_array('1006', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
                                            <li class="menu-item {{ areActiveRoutes(['admin.franchises.index','admin.franchises.update','admin.franchises.show'])}}" aria-haspopup="true">
                                                <a href="{{ route('admin.franchises.index') }}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">{{translate('All Franchises')}}</span>

                                                </a>
                                            </li>
                                            <li class="menu-item {{ areActiveRoutes(['admin.franchises.create'])}}" aria-haspopup="true">
                                                <a href="{{ route('admin.franchises.create') }}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">{{translate('Add Franchise')}}</span>
        ...
        <!--Transactions-->
        @if( in_array($user_type,['admin','customer','branch','captain']) || in_array('1106', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
...
@if ($addon != null)
    @if($addon->activated)
        @if($user_type == 'admin' || in_array('1105', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <li class="menu-item menu-item-submenu  {{ areActiveRoutes(['admin.shipments.barcode.scanner','admin.deliveryTime.index','admin.dimensionConfig.index','admin.deliveryWeightConfig.index','admin.codConfig.index','admin.pickupWeightConfig.index','admin.packages.index','admin.shipments.settings','admin.shipments.covered_countries','admin.areas.index','admin.areas.create','admin.shipments.settings.fees','admin.reasons.index'])}}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item {{ areActiveRoutes(['admin.deliveryWeightConfig.index'])}}" aria-haspopup="true">
                            <a href="{{ route('admin.deliveryWeightConfig.index') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">{{translate('Delivery Weight Config')}}</span>
                            </a>
                        </li>
                        <li class="menu-item {{ areActiveRoutes(['admin.pickupWeightConfig.index'])}}" aria-haspopup="true">
                            <a href="{{ route('admin.pickupWeightConfig.index') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">{{translate('Pickup Weight Config')}}</span>
                            </a>
                        </li>
                        <li class="menu-item {{ areActiveRoutes(['admin.codConfig.index'])}}" aria-haspopup="true">
                            <a href="{{ route('admin.codConfig.index') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">{{translate('COD Config')}}</span>
                            </a>
                        </li>
                        <li class="menu-item {{ areActiveRoutes(['admin.dimensionConfig.index'])}}" aria-haspopup="true">
                            <a href="{{ route('admin.dimensionConfig.index') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">{{translate('Dimension Config')}}</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item {{ areActiveRoutes(['admin.reasons.index'])}}" aria-haspopup="true">
                            <a href="{{ route('admin.reasons.index') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">{{translate('Reasons For Deletion')}}</span>
                            </a>
                        </li>
