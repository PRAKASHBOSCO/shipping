            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'new_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="new_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="input-group">
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('1108', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="update_shipment_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'update_shipment', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="update_shipment_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'update_shipment', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="update_shipment_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'update_shipment', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'update_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="update_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'update_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('1007', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_captain_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_captain', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_captain_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_captain', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_captain_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_captain', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'new_captain', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="new_captain_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_captain', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('1005', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_client_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_client', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_client_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_client', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_client_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_client', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'new_client', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="new_client_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_client', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('20', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_staff_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_staff', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_staff_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_staff', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_staff_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_staff', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'new_staff', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="new_staff_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_staff', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('1008', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_mission_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_mission', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_mission_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_mission', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="new_mission_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_mission', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'new_mission', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="new_mission_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'new_mission', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('1008', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="mission_action_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'mission_action', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="mission_action_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'mission_action', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="mission_action_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'mission_action', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'mission_action', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="mission_action_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'mission_action', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
        ...
        @if( in_array($user_type,['admin','stuff']) || in_array('1108', json_decode(Auth::user()->staff->role->permissions ?? "[]")))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="shipment_action_administrators" <?php if(!isset($notify['administrators'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'shipment_action', 'administrators', false)" >
                        @foreach(\App\User::where('user_type', 'admin')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['administrators']) && in_array($user->id, $notify['administrators'])) echo "selected";?>>{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="shipment_action_roles" <?php if(!isset($notify['roles'])) echo "disabled";?> data-live-search="true" multiple="multiple" data-actions-box="true" data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'shipment_action', 'roles', false)">
                        @foreach(\App\Role::get() as $role)
                            <option value="{{$role->id}}" <?php if(isset($notify['roles']) && in_array($role->id, $notify['roles'])) echo "selected";?>>{{$role->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'shipment_action', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="shipment_action_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'shipment_action', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" id="shipment_action_employees" <?php if(!isset($notify['employees'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'shipment_action', 'employees', false)">
                        @foreach(\App\User::where('user_type', 'staff')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['employees']) && in_array($user->id, $notify['employees'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'aprroved_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="aprroved_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'aprroved_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'reject_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="reject_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'reject_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'assigned_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="assigned_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'assigned_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'received_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="received_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'received_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'deliverd_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="deliverd_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'deliverd_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'supplied_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="supplied_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'supplied_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'returned_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="returned_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'returned_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'returned_to_stock_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="returned_to_stock_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'returned_to_stock_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <label class="checkbox checkbox-inline checkbox-success">
                                <input type="checkbox" onchange="updateSettings(this, 'returned_to_sender_shipment', 'branchs')" <?php if(isset($notify['branchs'])) echo "checked";?> /><span></span>
                            </label>
                        </span>
                        <span class="input-group-text font-weight-bolder">{{translate('Branchs')}}</span>
                    </div>
                    <select class="form-control selectpicker" id="returned_to_sender_shipment_branchs" <?php if(!isset($notify['branchs'])) echo "disabled";?> data-live-search="true" multiple="multiple"  data-actions-box="true"  data-header="{{translate('Select an option')}}" onchange="updateSettings(this, 'returned_to_sender_shipment', 'branchs', false)">
                        @foreach(\App\User::where('user_type', 'branch')->get() as $user)
                            <option value="{{$user->id}}" <?php if(isset($notify['branchs']) && in_array($user->id, $notify['branchs'])) echo "selected";?> >{{$user->name}}</option>
                        @endforeach
                    </select>
