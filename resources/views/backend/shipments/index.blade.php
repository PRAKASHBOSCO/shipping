...
<div class="card card-custom gutter-b">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="row align-items-center">
                            <div class="my-2 col-md-4 my-md-0">
                                <div class="input-icon">
                                    <input type="text" name="code" value="{{ request('code') }}" class="form-control" placeholder="{{translate('Shipment Code')}}" id="kt_datatable_search_query" />
                                    <span>
                            ...
                            <div class="my-2 col-md-4 my-md-0">
                                <div class="input-icon">
                                    <input type="text" name="order_id" value="{{ request('order_id') }}" class="form-control" placeholder="{{translate('Shipment Order ID')}}" id="" />
                                    <span>
                                        <i class="flaticon2-search-1 text-muted"></i>
                                    </span>
                                </div>
                            ...
                            @if($auth_user->user_type != "customer")
                                <div class="my-2 col-md-4 mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select name="client_id" class="form-control kt-select2 select-client" id="kt_datatable_search_status">
                            ...
                            <div class="my-2 col-md-4 mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select name="type" class="form-control kt-select2 select-type" >
                                        <option value="">All</option>
                                        @if($type == null || $type == \App\Shipment::PICKUP)
                                        <option {{ $type == \App\Shipment::PICKUP ? 'selected' : '' }} value="{{\App\Shipment::PICKUP}}">{{translate('Pickup')}}</option>
                                        @endif
                                        @if($type == null || $type == \App\Shipment::DROPOFF)
                                        <option {{ $type == \App\Shipment::DROPOFF ? 'selected' : '' }} value="{{\App\Shipment::DROPOFF}}">{{translate('Dropoff')}}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <!--        @php $from_country_id = request('from_country_id') @endphp-->
                            ...
                            <!--            <option {{ $from_country_id == $country->id ? 'selected' : '' }} value="{{$country->id}}">{{$country->name}}</option>-->
                            <!--            @endforeach-->
                            <!--        </select>-->
                            <!--    </div>-->
                            <!--</div>-->
                            ...
                            <!--<div class="my-2 col-md-4 mb-2">-->
                            <!--    <div class="d-flex align-items-center">-->
                            <!--        <label class="mb-0 mr-3 d-none d-md-block">{{translate('From Region')}}:</label>-->
                            <!--        <select name="from_region_id" id="change-state-from" class="form-control kt-select2 select-from-region">-->
                            <!--        </select>-->
                            <!--    </div>-->
                            <!--</div>-->
                            ...
                            <!--<div class="my-2 col-md-4 my-md-0">-->
                            <!--    <div class="d-flex align-items-center">-->
                            <!--        <label class="mb-0 mr-3 d-none d-md-block">{{translate('From Area')}}:</label>-->
                            <!--        <select name="from_area_id" class="form-control kt-select2 select-from-area">-->
                            <!--        </select>-->
                            <!--    </div>-->
                            <!--</div>-->
                            ...
                            <!--        @php $to_country_id = request('to_country_id') @endphp-->
                            <!--        <select name="to_country_id" id="change-country-to" class="form-control kt-select2 select-to-country">-->
                            <!--            <option value="">{{translate('All')}}</option>-->
                            <!--            @foreach(\App\Country::where('covered', 1)->get() as $country)-->
                            <!--            <option {{ $to_country_id == $country->id ? 'selected' : '' }} value="{{$country->id}}">{{$country->name}}</option>-->
                            <!--            @endforeach-->
                            <!--        </select>-->
                            <!--    </div>-->
                            <!--</div>-->
                            ...
                            <!--<div class="my-2 col-md-4 my-md-0">-->
                            <!--    <div class="d-flex align-items-center">-->
                            <!--        <label class="mb-0 mr-3 d-none d-md-block">{{translate('To Region')}}:</label>-->
                            <!--        <select name="to_region_id" id="change-state-to" class="form-control kt-select2 select-to-region">-->
                            <!--        </select>-->
                            <!--    </div>-->
                            <!--</div>-->
                            ...
                            <!--<div class="my-2 col-md-4 mb-2">-->
                            <!--    <div class="d-flex align-items-center">-->
                            <!--        <label class="mb-0 mr-3 d-none d-md-block">{{translate('To Area')}}:</label>-->
                            <!--        <select name="to_area_id" class="form-control kt-select2 select-to-area">-->
                            <!--        </select>-->
                            <!--    </div>-->
                            <!--</div>-->
                            ...
                            <div class="my-2 col-md-4 my-md-0">
                                <div class="d-flex align-items-center">
                                    <label class="mb-0 mr-3 d-none d-md-block">{{translate('Sort By')}}:</label>
                                    @php $sort_by = request('sort_by') @endphp
                                    <select name="sort_by" class="form-control kt-select2 select-sort" >
                                        @if($sort_by == null || $sort_by == \App\Shipment::LATEST)
                                        <option {{ $sort_by == \App\Shipment::LATEST ? 'selected' : '' }} value="{{\App\Shipment::PICKUP}}">{{translate('Latest')}}</option>
                                        @endif
                                        @if($sort_by == null || $sort_by == \App\Shipment::OLDEST)
                                        <option {{ $sort_by == \App\Shipment::OLDEST ? 'selected' : '' }} value="{{\App\Shipment::DROPOFF}}">{{translate('Oldest')}}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="my-2 col-md-4 my-md-0">
                                    <div class="d-flex align-items-center">
                                        <label class="mb-0 mr-3 d-none d-md-block">{{translate('Origin Branch')}}:</label>
                                        @php $branch_id = request('branch_id') @endphp
                                        <select name="branch_id" class="form-control kt-select2 select-branch" >
                                            <option value="">{{translate('All')}}</option>
                                            @foreach(\App\Branch::where('is_archived', 0)->get() as $Branch)
                                            <option {{ $branch_id == $Branch->id ? 'selected' : '' }} @if(isset($_GET['branch_id']) && $_GET['branch_id']==$Branch->id) selected @endif value="{{$Branch->id}}">{{$Branch->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="my-2 col-md-4 mb-2">
                                    <div class="d-flex align-items-center">
                                        <label class="mb-0 mr-3 d-none d-md-block">{{translate('Destination Branch')}}:</label>
                                        @php $to_branch_id = request('to_branch_id') @endphp
                                        <select name="to_branch_id" class="form-control kt-select2 select-branch" >
                                            <option value="">{{translate('All')}}</option>
                                            @foreach(\App\Branch::where('is_archived', 0)->get() as $Branch)
                                            <option {{ $to_branch_id == $Branch->id ? 'selected' : '' }} @if(isset($_GET['branch_id']) && $_GET['to_branch_id']==$Branch->id) selected @endif value="{{$Branch->id}}">{{$Branch->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="mt-5 col-lg-3 col-xl-12 mt-lg-0 d-flex">
                        <div>
                            ...
                            <button id="reset_search" type="reset" value="reset" class="px-6 btn btn-light-primary font-weight-bold">{{translate('Reset')}}</button>
                        </div>
                    </div>
    ...
    <form method="POST" action="{{route('admin.shipments.export')}}" id="search_form_export" style="display: flex;">
        @csrf
        <input type="hidden" name="page" value="{{ request('page') ? request('page') : 1  }}" />
        <input type="hidden" name="status" value="{{ $status ? $status : ''  }}" />
        <input type="hidden" name="code" value="{{ request('code') ? request('code') : '' }}" />
        <input type="hidden" name="order_id" value="{{ request('order_id') ? request('order_id') : ''  }}" />
        <input type="hidden" name="client_id" value="{{ request('client_id') ? request('client_id') : ''  }}" />
        <input type="hidden" name="type" value="{{ request('type') ? request('type') : ''  }}" />
        <input type="hidden" name="from_country_id" value="{{ request('from_country_id') ? request('from_country_id') : ''  }}" />
        <input type="hidden" name="to_country_id" value="{{ request('to_country_id') ? request('to_country_id') : ''  }}" />
        <input type="hidden" name="from_region_id" value="{{ request('from_region_id') ? request('from_region_id') : ''  }}" />
        <input type="hidden" name="to_region_id" value="{{ request('to_region_id') ? request('to_region_id') : ''  }}" />
        <input type="hidden" name="from_area_id" value="{{ request('from_area_id') ? request('from_area_id') : ''  }}" />
        <input type="hidden" name="to_area_id" value="{{ request('to_area_id') ? request('to_area_id') : ''  }}" />
        <input type="hidden" name="sort_by" value="{{ request('sort_by') ? request('sort_by') : ''  }}" />
        <input type="hidden" name="branch_id" value="{{ request('branch_id') ? request('branch_id') : ''  }}" />   
        <input type="hidden" name="to_branch_id" value="{{ request('to_branch_id') ? request('to_branch_id') : ''  }}" />  

        <button type="submit" class="px-6 ml-auto btn btn-light-primary font-weight-bold">{{translate('Export Shipments')}}</button>
    </form>
        ...
        <table class="table mb-0 aiz-table">
            <thead>
                <tr>
                    ...
                    @if($auth_user->user_type != "branch") <th>{{translate('To Branch')}}</th> @endif
                    ...
                    @endif
                    <th class="text-center">{{translate('Delivery method')}}</th>
            ...
            <tbody>
                ...
                @endphp
                     @foreach($shipments as $key=>$shipment)
                        ...
                        $destination_branch  = \App\Branch::where('is_archived', 0 )->where('id', $shipment->to_branch_id )->get();
                        $destination_branch_name = $destination_branch[0]['name'];
                        $destination_branch_id = $destination_branch[0]['id'];
                        @endphp
                        
                      @if($branch_id != $shipment->branch_id)
                       
                        <tr class="bg-light">
                            <td><label class="checkbox checkbox-success">
                                <input type="checkbox" onclick="check_client(this,{{$shipment->branch_id}})"/><span></span></label></td>
                            <th colspan="4">
                    ...
                    <tr>
                        <td>
                            ...
                            data-clientaddresssender="" 
                            data-clientaddress="{{$shipment->reciver_address}}" 
                            data-clientname="{{$shipment->reciver_name}}" data-clientstatehidden="{{$shipment->to_state_id}}" data-clientstate="{{$shipment->to_state->name ?? '' }}" data-clientareahidden="{{$shipment->to_area_id ?? '' }}" data-clientarea="{{$shipment->to_area->name ?? '' }}" data-clientid="{{$shipment->client->id ?? '' }}" data-paymentmethodid="{{$shipment->payment_method_id ?? '' }}" data-deliverymethodid="{{$shipment->delivery_method_id ?? ''}}" data-branchid="{{$shipment->branch_id ?? '' }}" data-branchname="{{$shipment->branch->name  ?? '' }}"  type="checkbox" 
                                class="sh-check checkbox-client-id-{{$shipment->branch_id}}" name="checked_ids[]" value="{{$shipment->id}}" /><span></span></label>
                            @endif
                        </td>
                        ...
                        @if( in_array($user_type ,['admin','customer']) || in_array('1100', $staff_permission) || in_array('1006', $staff_permission) )
                            <td><a href="{{route('admin.branchs.show',$destination_branch_id)}}">{{$destination_branch_name}}</a></td>
                        @else <td>{{$destination_branch_name}}</td>
                        @endif
                        @endif

                        <td>{{format_price(($shipment->tax + $shipment->shipping_cost + $shipment->insurance) - $shipment->discount_amt) }}</td>
                        ...
                        @endif
                        <td>
                            @if($shipment->delivery_method_id == 1) {{translate('Branch Pickup')}} @else {{translate('Door Delivery')}} @endif
                        </td>
                        ...
                        @if($status != "all") 
                            <td class="text-center">
                                ...
                                @if($status == \App\Shipment::APPROVED_STATUS && !$shipment->mission_id)
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" data-url="{{route('admin.shipments.action.confirm_amount', ['shipment_id' => $shipment->id ])}}" data-action="POST" onclick="openAjexedModel(this);" title="{{ translate('Show') }}">
...
<script type="text/javascript">
    ...
    $('#reset_search').click(function(e) {
        ...
        //reset select2
        $("select.select-client").select2({ allowClear: true }); // re-init to show default status
        $("select.select-type").select2({ allowClear: true });
        $("select.select-branch").select2({ allowClear: true });
        $("select.select-sort").select2({ allowClear: true });
        $("select.select-from-country").select2({ allowClear: true });
        $("select.select-from-region").select2({ allowClear: true });
        $("select.select-from-area").select2({ allowClear: true });
        $("select.select-to-country").select2({ allowClear: true });
        $("select.select-to-region").select2({ allowClear: true });
        $("select.select-to-area").select2({ allowClear: true });
    ...
    function openAssignShipmentCaptainModel(element, e) {
        ...
        $('.sh-check:checked').each(function() {
            selected.push($(this).data('clientid'));
            selected_payment_method.push($(this).data('paymentmethodid'));
            selected_delivery_method.push($(this).data('deliverymethodid'));
            // selected_address.push($(this).data('clientaddress'));
        ...
        if (selected.length != 0) 
        {
            if(mission_id[0] == ""){
                ...
                if (selected.length != 0) {
                    ...
                    selected_delivery_method.forEach((element, index) => { 
                        if(selected_delivery_method[index] == 2){
                            count_delivery_method++;
                        }
                    });
                    if(selected_payment_method.length == count_payment_method)
                    {
                        if(selected_delivery_method.length == count_delivery_method){
                        $('#tableForm').attr('action', $(element).data('url'));
                        $('#tableForm').attr('method', $(element).data('method'));
                        ...
                        Swal.fire("{{translate('Select only door delivery shipments')}}", "", "error");
                    }
                    }else{
                        Swal.fire("{{translate('Select shipments of the same payment method')}}", "", "error");
                    }
    ...
    function openAjexedModel(element) {
