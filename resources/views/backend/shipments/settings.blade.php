                ...
                <div class="mt-3 form-group row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group row">
                            <label class=" col-form-label">{{translate('Pickup mission done with shipment fees received ?')}}</label>
                            <div class="col-12 col-form-label">
                                <div class="radio-inline">
                                    <label class="radio radio-success">

                                        <input name="Setting[mission_done_with_fees_received]" @if(\App\ShipmentSetting::getVal('mission_done_with_fees_received')=='1' || \App\ShipmentSetting::getVal('mission_done_with_fees_received') == null) checked @endif value="1" type="radio" class="form-control" />
                                        <span></span>
                                        {{translate('Yes')}}
                                    </label>
                                    <label class="radio radio-danger">
                                        <input name="Setting[mission_done_with_fees_received]" @if(\App\ShipmentSetting::getVal('mission_done_with_fees_received')=='0' ) checked @endif value="0" type="radio" class="form-control" />
                                        <span></span>
                                        {{translate('No, mission only has been done.')}}
                                    </label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group row">
                            <label class=" col-form-label">{{translate('Show register in driver app ?')}}</label>
                            <div class="col-12 col-form-label">
                                <div class="radio-inline">
                                    <label class="radio radio-success">

                                        <input name="Setting[show_register_in_driver_app]" @if(\App\ShipmentSetting::getVal('show_register_in_driver_app')=='1' || \App\ShipmentSetting::getVal('show_register_in_driver_app') == null) checked @endif value="1" type="radio" class="form-control" />
                                        <span></span>
                                        {{translate('Yes')}}
                                    </label>
                                    <label class="radio radio-danger">
                                        <input name="Setting[show_register_in_driver_app]" @if(\App\ShipmentSetting::getVal('show_register_in_driver_app')=='0' ) checked @endif value="0" type="radio" class="form-control" />
                                        <span></span>
                                        {{translate('No')}}
                                    </label>
                ...
                @if(!$otp_activation)
                    <div class="row">
                        <div class="alert alert-danger col-lg-8" style="margin: auto;margin-top:10px;" role="alert">
                            {{translate('To Active OTP Confirmation Type , Config SMS Gateways First')}},
