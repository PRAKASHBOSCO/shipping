...
@php
    ...
    {   
        ...
        $branch_name_query = \App\Branch::where('id',$branch_id)->get();
        $branch_name = $branch_name_query[0]['name'];
    }
     if($user_type == 'staff' )
    {
               $staff = \App\Staff::where('user_id', Auth::user()->id)->where('role_id', 3)->first();
    ...
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('admin.shipments.store') }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                @if($user_type == 'branch' || $user_type == 'staff')
                <input type="hidden" name="Shipment[branch_id]" value="{{$branch_id}}"/>
                <div><span> {{$branch_name}} </span></div> 
                @else
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 payment-method" id="delivery_method_id" name="Shipment[delivery_method_id]">
                                            <option value="1" selected>{{translate('Branch Pickup')}}</option>
                                            <option value="2">{{translate('Door Delivery')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                    ...
                                    <div class="input-group date">
                                        @php
                                            ...
                                            if($defult_shipping_date == null )
                                            {
                                                ...
                                                $delivery_data = \Carbon\Carbon::now()->addDays(1);
                                            }else{
                                                $shipping_data = \Carbon\Carbon::now()->addDays($defult_shipping_date);
                                                $delivery_data = \Carbon\Carbon::now()->addDays($defult_shipping_date + 1);
                                            }
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 payment-method" onchange="selectIsTriggered()" id="customer_type" name="Shipment[customer_type]">
                                        <option value="walkin" selected>{{translate('Walkin Customer')}}</option>
                                        <option value="corporate">{{translate('Corporate Customer')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 payment-method" id="parcel_type" onchange="decideCODInput();" name="Shipment[parcel_type]">
                                        ...
                                        <option value="noncod" selected>{{translate('Non COD')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group client-select" id="walkin_customer_container" style="display: none;">
                                    <label>{{translate('Client/Sender')}}:</label>
                                    <input type="text" placeholder="{{translate('Client/Sender')}}" class="form-control" name="Shipment[walkin_customer_name]"  />
                                </div>
                            </div>
                            @if($auth_user->user_type == "customer")
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{translate('Client Phone')}}:</label>
                                            ...
                                            @endphp
                                            <input placeholder="{{translate('Client Phone')}}" name="Shipment[client_phone]" id="client_phone" value="{{$client_phone->responsible_mobile}}" class="form-control" />
                                    </div>
                                </div>
                            @else
                                <input type="hidden" placeholder="{{translate('Client Phone')}}" value="" name="Shipment[client_phone]" id="client_phone" class="form-control" />
                            @endif
                            <div class="col-md-4" id="walkin_customer_phone_container" style="display: none;">
                                <div class="form-group">
                                    <label>{{translate('Client Phone')}}:</label>
                                    <input placeholder="{{translate('Client Phone')}}" name="Shipment[client_phone]" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="{{translate('Client Address')}}" name="Shipment[walkin_client_address]" id="walkin_client_address" class="form-control" style="display: none;" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Receiver Phone')}}" name="Shipment[reciver_phone]" class="form-control" minlength="11" maxlength="11"  title="Please enter exactly 11 digits" onkeypress="return isNumberKey(event)"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Discount')}}" name="Shipment[discount]" value="0" class="form-control" />
                                </div>
                            </div>
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div data-repeater-list="Package" class="col-lg-12">
                                    <div data-repeater-item class="row align-items-center" style="margin-top: 15px;padding-bottom: 15px;padding-top: 15px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
                                        ...
                                        <div class="col-md-12" style="margin-top: 10px;">
                                            <label>{{translate('Dimensions [Length + Width + Height] (cm)')}}:</label>
                                        </div>
                                        <div class="col-md-3">

                                            <input class="dimensions_r dimensions_r_length" type="number" min="1" class="form-control" placeholder="{{translate('Length')}}" name="length" value="1" />

                                        </div>
                                        <div class="col-md-3">

                                            <input class="dimensions_r dimensions_r_width" type="number" min="1" class="form-control" placeholder="{{translate('Width')}}" name="width" value="1" />

                                        </div>
                                        <div class="col-md-3">

                                            <input class="dimensions_r dimensions_r_height" type="number" min="1" class="form-control " placeholder="{{translate('Height')}}" name="height" value="1" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" placeholder="{{translate('Delivery Time')}}" value="{{$delivery_data->toDateString() }}" name="Shipment[delivery_time]" autocomplete="off" class="form-control" id="delivery_time" />
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="la la-calendar"></i>
                                                </span>
...
<script type="text/javascript">
    ...
    // Decide fields for walking and corporate customers
    function selectIsTriggered()
    {
        var id = document.getElementById("customer_type").value;
        if(id == 'walkin') {
            $('#corporate_customer_container').css('display', 'none');
            $('#walkin_customer_container').css('display', 'block');
            $('#walkin_customer_phone_container').css('display', 'block');
            $('#client_phone').css('display', 'none');
            $('#corporate_customer_address').css('display', 'none');
            $('#walkin_client_address').css('display', 'block');
        } else {
            $('#corporate_customer_container').css('display', 'block');;
            $('#walkin_customer_container').css('display', 'none');
            $('#walkin_customer_phone_container').css('display', 'none');
            $('#client_phone').css('display', 'block');
            $('#corporate_customer_address').css('display', 'block');
            $('#walkin_client_address').css('display', 'none');
        }
    }

    // Decide COD input field
    function decideCODInput()
    {
        var id = document.getElementById("parcel_type").value;
        if(id == 'cod') {
            $('#cod_container').css('display', 'block');
        } else {
            $('#cod_container').css('display', 'none');
            document.getElementsByName("Shipment[amount_to_be_collected]")[0].value = 0;
        }
    }
    ...
    function openAddressDiv()
    {
        ...
        setTimeout(function(){
            $('#client-addressess').select2("close");
        }, 500);
    }
    ...
    @if($user_type == 'admin' || $user_type == 'branch' || in_array('1005', $staff_permission) )
        .on('select2:open', () => {
    ...
    function get_estimation_cost() {
        ...
        var select_packages_height = document.getElementsByClassName('dimensions_r_height');
        var select_packages_width = document.getElementsByClassName('dimensions_r_width');
        var select_packages_length = document.getElementsByClassName('dimensions_r_length');
        var select_packages_quantity = document.getElementsByClassName('kt_touchspin_qty');
        var select_packages_weight = document.getElementsByClassName('kt_touchspin_weight');

        var type = document.querySelector('input[name="Shipment[type]"]:checked').value;
        var type_delivery = document.getElementById('delivery_method_id').value;
        var cod_amt = document.getElementsByName("Shipment[amount_to_be_collected]")[0].value;
        var parcel_type = document.getElementById("parcel_type").value;
        var taxable = document.getElementsByName("Shipment[taxable]")[0].value;
        var discount = document.getElementsByName("Shipment[discount]")[0].value;
        
        var from_branch_id = document.getElementsByName("Shipment[branch_id]")[0].value;
        var to_branch_id = document.getElementsByName("Shipment[to_branch_id]")[0].value;
        @if($user_type == 'customer')
        ...
        for (let index = 0; index < select_packages.length; index++) {
            if(select_packages[index].value){
                ...
                package_ids[index]["height"] = select_packages_height[index].value;
                package_ids[index]["width"] = select_packages_width[index].value;
                package_ids[index]["length"] = select_packages_length[index].value;
                package_ids[index]["qty"] = select_packages_quantity[index].value;
                package_ids[index]["weight"] = select_packages_weight[index].value;
            }else{
        ...
        $.post('{{ route('admin.shipments.get-estimation-cost') }}', request_data, function(response){
            ...
            if({{$is_def_mile_or_fees}} =='2')
            {
                ...
                document.getElementById("shipping_distance_cost").innerHTML = '&nbsp;'+response.shipping_distance_cost;
            }else if({{$is_def_mile_or_fees}} =='1')
            {
                document.getElementById("mile_cost").innerHTML = '&nbsp;'+response.shipping_cost;
                document.getElementById("mile_distance_cost").innerHTML = '&nbsp;'+response.shipping_distance_cost;
            }
            document.getElementById("tax_duty").innerHTML = '&nbsp;'+response.tax;
            document.getElementById("cod_fees").innerHTML = '&nbsp;'+response.cod_cost;
            document.getElementById("door_delivery_fees").innerHTML = '&nbsp;'+response.door_delivery_cost;
            document.getElementById("discount_fees").innerHTML = '-'+response.discount;
            document.getElementById("pickup_cost").innerHTML = '&nbsp;'+response.pickup_cost;
            document.getElementById("total_cost").innerHTML = '&nbsp;'+response.total_cost;
            if(type == 2) {
                $('#pickup_cost_container').css('display', 'none');
            } else {
                $('#pickup_cost_container').css('display', 'flex');
            }
            if(taxable == 1) {
                $('#taxable_container').css('display', 'flex');
            } else {
                $('#taxable_container').css('display', 'none');
            }
            if(parcel_type == 'cod') {
                $('#cod_fees_container').css('display', 'flex');
            } else {
                $('#cod_fees_container').css('display', 'none');
            }
            if(type_delivery == 2) {
                $('#door_delivery_fees_container').css('display', 'flex');
            } else {
                $('#door_delivery_fees_container').css('display', 'none');
            }
            if(discount > 0) {
                $('#discount_fees_container').css('display', 'flex');
            } else {
                $('#discount_fees_container').css('display', 'none');
            }
    ...
    function getDeliveryDate() {
        ...
        $.post('{{ route('admin.shipments.get-estimation-delivery') }}', request_data, function(response){
            $("#delivery_time").datepicker("setDate", new Date(response));
        });
    }
    ...
    $(document).ready(function() {
        ...
        $('#kt_datepicker_3, #delivery_time').datepicker({
