                        ...
                        <table class="table mb-0 aiz-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{translate('Cost District')}}</th>
                                    <th>{{translate('Cost State')}}</th>
                                ...
                                @foreach($packages as $key => $package)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="package_extra[]" class="form-control" id="" value="{{$package->cost}}" />
                                            <input type="hidden" name="package_id[]" value="{{$package->id}}">

                                        </td>
                                        <td>
                                            <input type="text" name="package_extra_state[]" class="form-control" id="" value="{{$package->cost_state}}" />                                            
                                        </td>
                                    </tr>
