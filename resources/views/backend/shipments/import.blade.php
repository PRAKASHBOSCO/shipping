...
@php
    ...
    $addressess      = \App\AddressClient::where('client_id', Auth::user()->userClient->client_id )->get();
...
@section('content')
    ...
    <div class="mx-auto mb-5 col-lg-12">
        ...
        <div class="alert alert-danger" role="alert">
            {{translate('Please: Be sure shipments have right branch')}}.
        </div>
    ...
    <div class="mb-4 col-lg-12 table-responsive table-custom-container">
        <table class="table table-hover ">
            ...
            <tbody>
                        ...
                        <div class="modal" id="addressess">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{translate('Your Addressess')}}</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th scope="col">{{translate('Address Name')}}</th>
                                                    <th scope="col">{{translate('Value')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                <tr>
                                                    <td colspan="2">{{translate('Nothing found')}}!</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                        ...
                        <div class="modal" id="areas">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{translate('Areas')}}</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">{{translate('Area Name')}}</th>
                                                    <th scope="col">{{translate('Area ID')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                ...
                <tr>
                    <td>{{translate('delivery_time')}}</td>
                    <td>
                        <span class="badge badge-info">{{translate('Optional')}}</span>
                    </td>
                    <td>
                        <p data-toggle="modal" data-target="#deliveryTimes">
                            <u><b>{{translate('Click To Get The Value')}}</b></u>
                        </p>
                        ...
                        <div class="modal" id="deliveryTimes">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{translate('Delivery Times')}}</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                ...
                <tr>
                    <td>{{translate('collection_time')}}</td>
                    <td>
                        <span class="badge badge-info">{{translate('Optional')}}</span>
                    </td>
                    <td>-</td>
                    <td>{{translate('01:12 AM')}}</td>
                </tr>
