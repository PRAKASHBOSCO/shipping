...
<div class="mx-auto col-lg-12">
    <div class="card">
        ...
        <input type="text" class="form-control" placeholder="{{translate('Here')}}" name="Client[bank_info]" value="{{$client->bank_info}}">
        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control kt-select2 branch" id="select-how" name="Client[branch_id]">
                        ...
                        <option @if($client->branch_id == $branch->id) selected @endif value="{{$branch->id}}">{{$branch->name}}</option>
                        @endforeach
                ...
                <div class="form-group" id="kt_repeater_1">
                    <div data-repeater-list="address">
                        ...
                        @forelse($client->addressess as $address)
                                ...
                                <div class="row">
                                    ...
                                    @if($is_def_mile_or_fees == 1)
                                        <div class="def_mile_costs form-group col-md-4">
                                            ...
                                            <input type="number" min="0" class="form-control" placeholder="{{translate('Default Returned Mile Cost')}}" value="{{$client->def_return_mile_cost}}" name="Client[def_return_mile_cost]">
                                        </div>
                                    @elseif($is_def_mile_or_fees == 2)
                                        <div class="def_shiping_costs form-group col-md-4">
                                            <label>{{translate('Default Returned Shipment Cost')}}({{currency_symbol()}}):</label>
                                            <input type="number" min="0" class="form-control" placeholder="{{translate('Default Returned Shipment Cost')}}" value="{{$client->def_return_cost}}" name="Client[def_return_cost]">
                                        </div>
                                    @endif
                                </div>
                                <hr>
                ...
                fields: {
                    ...
                    "Client[responsible_mobile]": {
                     ...
                     "Client[bank_info]": {
                        validators: {
                            notEmpty: {
                                message: '{{translate("Client Bank Info is required!")}}'
                            }
                        }
                    },
                    "Client[branch_id]": {
