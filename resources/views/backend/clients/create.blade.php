    ...
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('admin.clients.store') }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" placeholder="{{translate('Owner Phone')}}" name="Client[responsible_mobile]" minlength="10" maxlength="10">
            </div>
                   
        <div class="form-group">
        <label>{{translate('National ID')}}:</label>
        <input type="text" class="form-control" placeholder="{{translate('National ID')}}" name="Client[bank_info]">
        </div>
                ...
                <!--</div>-->
<div id="emergency_hdden_div" style="display:none">
                <div class="form-group">
