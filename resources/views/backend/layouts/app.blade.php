...
<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
				...
				<div class="py-4 bg-white footer d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container text-center">
						...
						<div class="order-2 text-dark order-md-1">
							...
							<a href="http://champait.com" target="_blank"
								class="text-dark-75 text-hover-primary">{{translate('ChampaIT')}}</a> <!--<span class="mr-2 text-muted font-weight-bold">{{translate('v')}}{{ get_setting('current_version') }}</span>-->
						</div>
	...
	<!--end::Page Scripts-->
	@php
	if(Request::segment(2) == "clients" || Request::segment(2) == "transactions"){ 
	@endphp
